  ...
  blocks: [
    ...
    },
    {
      ...
      rows: [
        ...
        ['Global XP', 'The account-wide experience total. Unlocks Field Rangers.'],
        ['Team XP', 'Experience on one specific team. Promotes you on that team and unlocks the teams beyond it.'],
